...
def test_runfolder_processor(monkeypatch):
    ...
    As RunfolderProcessor carries most methods used to process NGS runfolders, this test suite allows
    us to test specific functions while skipping expensive operations like creating runfolders,
    running the NGS workflows or sending emails.
    """
