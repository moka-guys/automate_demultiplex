...
# (1 level up from this file)
test_document_root = "/".join(os.path.dirname(os.path.realpath(__file__)).split("/"))

document_root = ("{test_document_root}/data").format(test_document_root=test_document_root)

# # path to run folders
runfolders =  ("{document_root}/runfolder/").format(document_root=document_root)
