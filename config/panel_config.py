...
VCP1_PANELS = [
    k for k, v in PANEL_DICT.items() if v['panel_name'] == "vcp1"
]
VCP2_PANELS = [
    k for k, v in PANEL_DICT.items() if v['panel_name'] == "vcp2"
]
VCP3_PANELS = [
    k for k, v in PANEL_DICT.items() if v['panel_name'] == "vcp3"
]
...
CAN_PANELS = [k for k, v in PANEL_DICT.items() if v['pipeline'] == "can"]
