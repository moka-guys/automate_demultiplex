    ...
    CAPTURE_PANEL_DICT = {
        ...
        "CP2": {
            **DEFAULT_DICT,
            ...
            "sample_prefix": "NGS",
            "runtype": "CP2",
            "capture_pan_num": "Pan5346",
            "hsmetrics_bedfile": f"{BEDFILE_FOLDER}Pan5346_data.bed",
            "sambamba_bedfile": f"{BEDFILE_FOLDER}Pan5346_sambamba.bed",
            "variant_calling_bedfile": f"{BEDFILE_FOLDER}Pan5346_data.bed",
            "ed_readcount_bedfile": f"{BEDFILE_FOLDER}Pan5346_exomeDepth.bed",
            "happy_bedfile": f"{BEDFILE_FOLDER}Pan5346_data.bed",
