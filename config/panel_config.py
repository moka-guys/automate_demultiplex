    ...
    CAPTURE_PANEL_DICT = {
        ...
        "cp2": {
            **DEFAULT_DICT,
            ...
            "sample_prefix": "NGS",
            "runtype": "CP2",
            "capture_pan_num": "Pan5275",
            "hsmetrics_bedfile": f"{BEDFILE_FOLDER}Pan5275_data.bed",
            "sambamba_bedfile": f"{BEDFILE_FOLDER}Pan5275_sambamba.bed",
            "variant_calling_bedfile": f"{BEDFILE_FOLDER}Pan5275_data.bed",
