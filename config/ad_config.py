...
if BRANCH in ("main", "ws_main_branch_from_v45.4.1") and "pytest" not in sys.modules:  # Prod branch
...
class SWConfig(PanelConfig):
    ...
    if BRANCH in ("main", "ws_main_branch_from_v45.4.1"):  # Prod branch
...
class ToolboxConfig(PanelConfig):
    ...
    if BRANCH in ("main", "ws_main_branch_from_v45.4.1"):
