...
if BRANCH == "main" and "pytest" not in sys.modules:  # Prod branch
    ...
    ILLUMINA_RUNFOLDER = "/media/data3/share"
...
class ToolboxConfig(PanelConfig):
    ...
    FLAG_FILES = {
        ...
        "illumina_seq_complete": "RTAComplete.txt",  # Sequencing complete file for illumina run
        "aviti_seq_complete": "RunUploaded.json", # Sequencing complete file for aviti run
    }
    TEST_PROGRAMS_DICT = {
        "dx_toolkit": {
            "executable": "dx",
            "test_cmd": "dx --version" #f"{SDK_SOURCE}; dx --version",
        },
        "upload_agent": {
