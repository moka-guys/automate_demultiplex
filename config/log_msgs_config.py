...
LOG_MSGS = {
    ...
    "demux": {
        ...
        "bclconvert_start": "Demultiplexing started using bclconvert command: %s",
        "bclconvert_complete": "Demultiplexing completed successfully for %s",
        "bclconvert_failed": "Demultiplexing failed - bclconvert subprocess failed. Script exited. Stdout: %s. Stderr: %s",
        "demux_already_complete": "Demultiplexing already completed. bclconvert log found @ %s",
        ...
        "create_bclconvertlog_pass": "Created bclconvert logfile: %s",
        "create_bclconvertlog_fail": "Failed to create bclconvert logfile. Script exited. Exception: %s",
        ...
        "write_msg_to_bclconvertlog": "Message successfully written to bclconvert_output.log",
