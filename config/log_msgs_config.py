...
LOG_MSGS = {
    ...
    "demultiplex": {
        ...
        "ssfail_haltdemux": (
            "Samplesheet contains critical errors %s: %s. Please correct these, remove the sscheck_flagfile.txt file, "
            "(and the checksums assessed string from the md5checksum file if the sequencer has integrity checking) "
        ...
        "seq_without_ic": "Integrity check not required",
