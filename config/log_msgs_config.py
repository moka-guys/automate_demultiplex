...
LOG_MSGS = {
    ...
    "demux": {
        ...
        "sschecks_failed": (
            ...
            "SampleSheet check flag file(s) to continue processing"
        ),
        ...
        "ic_script_start": "Running integrity check script: %s",
        "ic_script_complete": "Integrity check script completed. filecheck.txt written to runfolder: %s",
        "ic_script_failed": "Integrity check script did not produce filecheck.txt for runfolder: %s",
        "checksumfilecheck_start": "Data integrity checks starting...",
        "ic_pass": "Integrity check passed. 'SUCCESS' message present in filecheck.txt: %s",
        "ic_fail": "Integrity check failed. 'SUCCESS' message absent from filecheck.txt: %s",
        "ic_already_assessed": "Integrity check failure previously assessed by AS for this run - skipping re-alert",
