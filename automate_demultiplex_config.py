...
rtacomplete_name = "RTAComplete.txt"
bcl2fastqlog_name = "bcl2fastq2_output.log"

if testing:
    bcl2fastq_path = "/usr/local/src/mokaguys/development_area/automate_demultiplex/test/demultiplex_test_files/"
else:
...
if not testing:
    ...
    # Folder containing demultiplex logs
    demultiplex_logfiles = "{}/Demultiplexing_log_files/".format(runfolders)

icfail_emailsubj = "DEMULTIPLEX ALERT: INTEGRITY CHECK FAILED"
icfail_emailmsg = "Run:\t{}\nPlease follow the protocol for when integrity checks fail"

demux_logmsgs = {
    'demux_script_start': "Automate demultiplex release {}: Demultiplex.py started on workstation",
    'demux_script_end': "Automate demultiplex release {}: Demultiplex.py complete. {} runfolder(s) processed",
    'demux_runfolder_start': "automate_demultiplex release: {} -------------- Assessing {}",
    'ic_fail': "Integrity check fail. Checksums do not match for {} see {}",
    'bcl2fastq_start': "Demultiplexing started for run {} using bcl2fastq command: {}",
    'bcl2fastq_complete': "bcl2fastq subprocess complete for run {}",
    'bcl2fastq_failed': "bcl2fastq subprocess failed for run {}",
    'demux_already_complete': "Demultiplexing already completed - bcl2fastq log found @ {} --- STOP ---",
    'demux_not_complete': "Demultiplexing not yet completed - no demultiplex log found @ {} --- CONTINUE ---",
    'sschecks_not_passed': "Samplesheet did not pass checks {}: {}",
    'sschecks_passed': "Samplesheet passed all checks {}",
    'run_finished': "Run finished - RTAComplete.txt found @ {}",
    'run_incomplete': "Run not yet complete (RTAComplete.txt file absent) --- STOP ---",
    'bcl2fastq_test_fail': "BCL2FastQ installation test failed",
    'bcl2fastq_test_pass': "BCL2FastQ installation test passed",
    'ssfail_haltdemux': "Demultiplexing halted due to samplesheet errors {}: {}",
    'ic_required': "Integrity check required",
    ...
    'ic_pass': "Integrity check for runfolder {} passed",
    'email_sending': "Sending an email. Recipient: {}. Subject: {}. Body: {}",
    'email_pass': "Email sent without error",
    'email_fail': "Error when sending email. Email not sent. Exception: {}",
    'create_bcl2fastqlog_pass': "Created bcl2fastq logfile for run {}",
    'create_bcl2fastqlog_fail': "Failed to create bcl2fastq logfile for run {}. Exception: {}",
    'create_tsobcl2fastqlog_pass': "bcl2fastq2_output.log file created for TSO run: {}",
    'create_tsobcl2fastqlog_fail': "Failed to create bcl2fastq2_output.log file for TSO run: {}. Exception: {}",
    'demux_complete': "Demultiplexing complete without error for run {}",
    'demux_error': "ERROR - DEMULTIPLEXING UNSUCCESSFUL (BCL2FastQ2 ERROR) "
                   "- Demultiplexing failed for run {}. Please see logfile {}",
    'bcl2fastqlog_empty': "ERROR - BCL2FASTQ2 logfile is empty for run {}. Please see logfile {}",
    'bcl2fastqlog_absent': "ERROR - BCL2FASTQ2 logfile does not exist for run {}. Please see logfile {}",
}
