...
wes_sentieon_samplename = " -istage-Ff0P73j0GYKX41VkF3j62F9j.sample="  # sample name for sention app - prevents sample being incorrectly parsed from fastq filename
